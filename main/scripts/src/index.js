System.register(["scripts/src/lib/excalibur.js"], function (exports_1, context_1) {
    ...
    var excalibur_js_1, excalibur_js_2, excalibur_js_3, excalibur_js_4, excalibur_js_5, excalibur_js_6, ex, TileMap, TiledMapFormat, TiledResource, parseJsonMap, decompressors;
            ...
            TiledResource = /** @class */ (function (_super) {
                    ...
                    _super.prototype.load.call(this).then(function (map) {
                        ...
                        excalibur_js_2.default.join.apply(_this, promises).then(function () {
                            ...
                            _this.data.tilesets.forEach(function (ts) {
                                ...
                                excalibur_js_6.default.getInstance().debug("[Tiled] Loading associated tileset: " + ts.image);
                            });
                            excalibur_js_2.default.join.apply(_this, promises).then(function () {
                                p.resolve(map);
                            }, function (value) {
                ...
                TiledResource.prototype.getTileMap = function () {
                    ...
                    for (var _i = 0, _a = this.data.tilesets; _i < _a.length; _i++) {
                        ...
                        var ss = new excalibur_js_5.default(ts.imageTexture, cols, rows, ts.tilewidth, ts.tileheight);
                        ...
                        if (layer.type === "tilelayer") {
                            for (var i = 0; i < layer.data.length; i++) {
                                ...
                                if (gid !== 0) {
                                    ...
                                    map.data[i].sprites.push(new excalibur_js_4.default(ts.firstgid.toString(), gid - ts.firstgid));
                                }
                            }
                        }
                    }
